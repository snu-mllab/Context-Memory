...
from .ccm_llama import update_position_ids, LinearMask
...
class MistralAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states = self.q_proj(hidden_states, comp_mask=comp_mask)
        key_states = self.k_proj(hidden_states, comp_mask=comp_mask)
        value_states = self.v_proj(hidden_states, comp_mask=comp_mask)
...
class MistralFlashAttention2(MistralAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        use_sliding_windows = (_flash_supports_window_size and
...
class MistralForCausalLM_CCM(MistralPreTrainedModel, GistGenerationMixin):
